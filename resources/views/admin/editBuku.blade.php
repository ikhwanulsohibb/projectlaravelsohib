...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.c ss">
...
name="kodeBuku" required value="{{
    ...
    <span class="text-danger"> @error('kodeBuku')
    {{ $message }} @enderror
    </span>
    ...
    <span class="text-danger"> @error('judulBuku')
    {{ $message }} @enderror
    </span>
...
<span class="text-danger"> @error('tahunTerbit')
{{ $message }} @enderror
</span>
...
<div class="form-group mt-1">
    <label class="text-secondary mb-2">Cover
        ...
        <img class="mt-3" style="width: 100px" src="{{ asset('img/' . $data->gambar) }}"
        alt="cover buku">
