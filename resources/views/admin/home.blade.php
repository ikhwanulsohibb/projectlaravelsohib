...
<div class="container">
    <div class="row mt-3">
        ...
        <div class="col-1"><a href="{{ route('logout') }}" style="text-decoration: none">
            ...
            <div class="row mt-3">
                ...
                control rounded" placeholder="Cari nama admin"
    ...
    <a href="{{ route('admin.inputberita') }}" class="btn btn-primary">Lihat Berita</a>

    <!-- Tambahkan tautan untuk mengupload data dosen -->
    <a href="{{ route('admin.InputDosen') }}" class="btn btn-primary">Input Data Dosen</a>

    <!-- Tambahkan tautan untuk mengupload data lulusan -->
    <a href="{{ route('admin.inputlulusan') }}" class="btn btn-primary">Input Data Lulusan</a>
</div>
