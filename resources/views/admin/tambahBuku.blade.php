                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('posttambahBuku') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mt-4">
                                ...
                                <input type="text" class="form-control border border-secondary form-control" name="kodeBuku"
                                    required value="{{ old('kodeBuku') }}">
                                <span class="text-danger">@error('kodeBuku') {{ $message }} @enderror</span>
                            </div><br>

                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Judul Buku</label>
                                <input type="text" class="form-control border border-secondary form-control" name="judulBuku"
                                    required value="{{ old('judulBuku') }}">
                                <span class="text-danger">@error('judulBuku') {{ $message }} @enderror</span>
                            </div><br>

                            <div class="form-group mt-1">
                                <label class="text-secondary mb-2">Penulis</label>
                                <input type="text" class="form-control border border-secondary form-control" name="penulis"
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="text" class="form-control border border-secondary form-control" name="penerbit"
                            ...
                            <div class="form-group mt-1">
                                ...
                                <input type="date" class="form-control border border-secondary form-control" name="tahunTerbit"
                                    required value="{{ old('tahunTerbit') }}">
                            ...
                            <div class="form-group mt-1">
                                ...
                                <textarea class="form-control" name="deskripsi" placeholder="Tulis deskripsi buku disini."
                                    style="height: 250px" required value="{{ old('deskripsi') }}"></textarea>
                            </div>
