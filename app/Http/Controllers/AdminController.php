...
class AdminController extends Controller
{
    ...
    public function postTambahBuku(Request $request)
    {
        ...
        $request->validate([
            'kodeBuku' => 'required', 'judulBuku' => 'required', 'penulis' => 'required', 'penerbit' => 'required',
            'tahunTerbit' => 'required|date', 'gambar' => 'required|image|max:5120', 'deskripsi' => 'required',
            'kategori' => 'required',
    ...
    public function posteditBuku(Request $request, $id)
    {
        ...
        $request->validate([
            'kodeBuku' => 'required', 'judulBuku' => 'required', 'penulis' => 'required', 'penerbit' => 'required',
            'tahunTerbit' => 'required', 'gambar' => 'image|max:5120',
            'deskripsi' => 'required',
            'kategori' => 'required'
    ...
    public function deleteBuku($id)
    {
        ...
        $filepath = public_path('images/' . $buku->gambar); // Menggunakan public_path untuk mendapatkan path file
    ...
    public function detailPeminjaman($idPeminjaman, $idUser, $idBuku)
    {
